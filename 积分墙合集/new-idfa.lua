...
function up(name,other)
	...
	idfalist.password = udid
	idfalist.phone = model
...
apparr.跳过={{{566, 83, 0xffffff},{534, 83, 0xffffff},{602, 72, 0x2644fa},{597, 90, 0x2645f8},}, 85, 521, 57, 626, 102}
apparr.同意={{{447, 810, 0xffffff},{189, 814, 0xff484a},{366, 783, 0xff484a},{305, 817, 0xff494b},}, 85, 126, 740, 501, 860}
function newidfa(name)
	local TIMEline = os.time()
	local OUTtime = rd(70,75)
	while os.time()- TIMEline < OUTtime do
		if active(bid[name]['appbid'],4)then
			if d(apparr.跳过,"apparr.跳过",true)then
			elseif d(apparr.同意,"apparr.同意",true)then
