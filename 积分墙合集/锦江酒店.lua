...
function _Server_get()
	...
	return{
		...
		getPhone = (function()
				RetStr = get('http://sms.wenfree.cn/public/?s=App.Sms.GetPhone'.."&imei="..phone_imei.."&phonename="..phone_name)
				log(RetStr)
		 ...
		 getMessage=(function()
            ...
            for i=1,25,1 do
				sys.msleep(3000)
				RetStr = get("http://sms.wenfree.cn/public/?s=App.Sms.getMessage".."&imei="..phone_imei.."&phonename="..phone_name)
				if RetStr then
					RetStr = json.decode(RetStr)
					log(RetStr);
					if RetStr.data.meg == success or RetStr.data.meg == 'success' then
...
function clickidfa(name,callbackkey)
	...
	postArr.osversion = os_version or sys.version()
	postArr.btype ='1'
	postArr.callback = e:escape("https://hbapi.honghongdesign.cn/callbackurl/id/")
...
page.我的2 = {{{401, 1059, 0x0d9ce4},{397, 1077, 0x0293e5},{409, 1105, 0x4ea0ed},}, 85, 358, 1038, 437, 1129}
...
page.首页3 = {{{74, 1065, 0x119fe3},{85, 1107, 0x1b85e7},{91, 1054, 0x0c9ae3},}, 85, 49, 1043, 127, 1122}
...
--						密码 = false
			...
			elseif d(page.首页,'page.首页') or d(page.首页2,'page.首页2') then
				click(579, 1079)
			elseif d(page.首页3,'page.首页3') 	then
				click(399, 1081)
			...
			elseif d(page.tips广告类1,'page.tips广告类1') or d(page.tips广告类2,'page.tips广告类2') then
				click(550, 137)
			elseif d(page.我的,'page.我的') or d(page.我的1,'page.我的1')or d(page.我的2,'page.我的2')  then
				click(193, 175)
