...
function clickidfa(name,callbackkey)
	local url = "http://tianxianfeedbackapp.openxiaoniu.com/common/apis/lw"
	local postArr = {}
	local curl = require('lcurl')
	local e = curl.easy()
	postArr.product_name= "10"
	postArr.market_name="lw104"
	postArr.adId = "2"
	postArr.channelId ="3"
	postArr.type ="async"
	postArr.idfa = idfa
...
page.首页2 = {{{82, 1077, 0xf8fcfe},{80, 1077, 0x19a6e2},{66, 1062, 0x0292e5},{96, 1086, 0x0292e5},{95, 1093, 0x55b7ee},}, 85, 50, 1044, 110, 1100}
page.我的 = {{{576, 1061, 0x333333},{574, 1089, 0x333333},{567, 1116, 0x333333},{585, 1122, 0x717171},{582, 1123, 0xffffff},}, 85, 553, 1046, 608, 1129}
page.我的 = {{{562, 1056, 0x0393e5},{562, 1080, 0x0292e5},{549, 1103, 0x0277e4},{572, 1112, 0xffffff},{580, 1111, 0x50a1ed},}, 85, 523, 1031, 596, 1128}
