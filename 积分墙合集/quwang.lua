...
apparr.同意={{{393, 849, 0xffffff},{212, 828, 0x3c7cfd},{451, 875, 0x3c7cfd},{236, 841, 0xb8d0fe},}, 85, 141, 789, 506, 899}
apparr.随便逛逛={{{562, 77, 0x9199b2},{479, 71, 0x636e92},{593, 75, 0x636e92},}, 85, 446, 45, 610, 94}
-- 粉笔
function newidfa(name)
	local TIMEline = os.time()
	local OUTtime = rd(60,80)
	while os.time()- TIMEline < OUTtime do
		if active(bid[name]['appbid'],4)then
			if d(apparr.right,"apparr.right",true)then
			elseif d(apparr.同意,"apparr.同意",true)then
			elseif d(apparr.随便逛逛,"apparr.随便逛逛",true)then
			else
