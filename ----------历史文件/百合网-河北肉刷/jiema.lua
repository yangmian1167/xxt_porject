...
--------------------------快米--------------------------------------
api = "http://api.kmiyz.com/api/do.php"--易码开发接口地址，请从易码官网查询当前可用的接口地址
laixin_user = 'a15240678777'  --登录易码的账号，如果填写了Token项，此处可以为空
laixin_pwd = 'Tyx168777'  --登录易码的密码，如果填写了Token项，此处可以为空
token = '0d506a1636af3b5873c6914fb8d89f9e' --Token值，可以调用登录接口获取，也可以登录易码网站从个人中心首页复制
